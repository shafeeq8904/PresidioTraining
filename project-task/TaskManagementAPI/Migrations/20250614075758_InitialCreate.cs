        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskStatusLogs_TaskItems_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "TaskItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskStatusLogs_Users_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusLogs_ChangedById",
                table: "TaskStatusLogs",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusLogs_TaskItemId",
                table: "TaskStatusLogs",
                column: "TaskItemId");
