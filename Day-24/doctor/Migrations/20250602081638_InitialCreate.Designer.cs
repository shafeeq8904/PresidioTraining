...
namespace doctor.Migrations
{
    ...
    [Migration("20250602081638_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("doctor.Models.DTOs.DoctorSpecialities.DoctorsBySpecialityResponseDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("doctor.Models.Doctor", b =>
                {
                    b.HasOne("doctor.Models.User", "User")
                        .WithOne("Doctor")
                        .HasForeignKey("doctor.Models.Doctor", "Email")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("doctor.Models.Patient", b =>
                {
                    b.HasOne("doctor.Models.User", "User")
                        .WithOne("Patient")
                        .HasForeignKey("doctor.Models.Patient", "Email")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
